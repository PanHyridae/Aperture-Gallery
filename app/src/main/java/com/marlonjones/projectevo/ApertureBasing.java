...
public class ApertureBasing extends Application{
	...
	public void onConfigurationChanged(Configuration newConfig) {
	 ...
	 public static void checkDisplaySize() {
	        try {
	            WindowManager manager = (WindowManager) ApertureBasing.applicationContext.getSystemService(Context.WINDOW_SERVICE);
	            if (manager != null) {
