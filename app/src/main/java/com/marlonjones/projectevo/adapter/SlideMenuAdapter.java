package com.marlonjones.projectevo.adapter;
...
public class SlideMenuAdapter extends BaseAdapter{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView==null) {
			...
			convertView=inflater.inflate(com.marlonjones.projectevo.R.layout.inflate_slidingrow, null);
			mViewHolder.imgLogo=(ImageView)convertView.findViewById(com.marlonjones.projectevo.R.id.inflate_imgLogo);
			mViewHolder.txtName=(TextView)convertView.findViewById(com.marlonjones.projectevo.R.id.inflate_textLogo);
